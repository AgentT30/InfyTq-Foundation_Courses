...
class Employee(Job):
    ...
    def elapsed_time(self, no_of_mins):
        if super().elapsed_time(no_of_mins):
...
class Company(Employee):
    ...
    def elapsed_time(self, no_of_mins):
        if Employee.elapsed_time(no_of_mins):
            completed_jobs.append(Job.get_name())
